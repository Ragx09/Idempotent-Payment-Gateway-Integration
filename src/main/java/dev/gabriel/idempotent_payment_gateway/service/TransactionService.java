...
/**
 * Core ledger service for the idempotent payment gateway: applies debits/credits with
 * {@code PESSIMISTIC_WRITE} account locking so concurrent requests cannot corrupt balances
 * (pairs with Redis distributed locks and idempotency keys at the API layer).
 */
@Service
